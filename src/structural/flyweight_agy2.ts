...
class BookType {
  constructor(
    public readonly p1: string, public readonly p2: string, public readonly p3: string, public readonly p4: string, public readonly p5: string,
    public readonly p6: string, public readonly p7: string, public readonly p8: string, public readonly p9: string, public readonly p10: string,
    public readonly p11: string, public readonly p12: string, public readonly p13: string, public readonly p14: string, public readonly p15: string,
    public readonly p16: string, public readonly p17: string, public readonly p18: string, public readonly p19: string, public readonly p20: string,
    public readonly p21: string, public readonly p22: string, public readonly p23: string, public readonly p24: string, public readonly p25: string,
  ) {}
}
...
class BookFactory {
  ...
  static getBookType(
    ...
    const key = `${p1}_${p2}_${p3}_${p4}_${p5}_${p6}_${p7}_${p8}_${p9}_${p10}_${p11}_${p12}_${p13}_${p14}_${p15}_${p16}_${p17}_${p18}_${p19}_${p20}_${p21}_${p22}_${p23}_${p24}_${p25}`;
    if (!this.bookTypes.get(key)) {
      this.bookTypes.set(key, new BookType(
...
class Store {
  ...
  storeBook(
    ...
    const bookType = BookFactory.getBookType(
      p1, p2, p3, p4, p5, p6, p7, p8, p9, p10,
      p11, p12, p13, p14, p15, p16, p17, p18, p19, p20,
      p21, p22, p23, p24, p25
    );
    this.books.push(
      new Book(name, price, p26, p27, p28, bookType)
    );
  }
}
